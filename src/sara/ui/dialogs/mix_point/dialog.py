...
from .editor_helpers_ui import MixPointEditorHelpersMixin
from .events_ui import MixPointEventsMixin
from .loudness_ui import MixPointLoudnessMixin
from .position_ui import MixPointPositionMixin
from .preview_ui import MixPointPreviewMixin
...
class MixPointEditorDialog(
    MixPointLoudnessMixin,
    MixPointPositionMixin,
    MixPointEditorHelpersMixin,
    MixPointEventsMixin,
    MixPointPreviewMixin,
    wx.Dialog,
):
